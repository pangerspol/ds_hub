    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sharepoint_url', models.CharField(blank=True, max_length=500)),
                ('main_folder_id', models.CharField(blank=True, max_length=500)),
                ('expense_folder_id', models.CharField(blank=True, max_length=500)),
                ('lexviamail_folder_id', models.CharField(blank=True, max_length=500)),
